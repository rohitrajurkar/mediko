...
public class ClinicTimingActivity extends AppCompatActivity {
    ...
    String et_monday1 = "Closed", et_monday2 = "Closed", et_tuesday = "Closed", et_tuesday1 = "Closed",
            et_wensday = "Closed", et_wensday1 = "Closed", et_thurday = "Closed", et_thurday1 = "Closed", et_friday = "Closed", et_friday1 = "Closed", et_saturday = "Closed", et_saturday1 = "Closed", et_sunday = "Closed", et_sunday1 = "Closed";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clinic_timing);
        ...
        dRef = FirebaseDatabase.getInstance().getReference().child("ClinicTiming");
                    ...
                    dRef.child(mUser.getUid()).updateChildren(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(ClinicTimingActivity.this, "Updated", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }
                    });

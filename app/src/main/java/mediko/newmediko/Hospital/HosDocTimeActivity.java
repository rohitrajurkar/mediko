...
public class HosDocTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hos_doc_time);
        progressDialog = new ProgressDialog(this);
        fAuth = FirebaseAuth.getInstance();
        mUser = fAuth.getCurrentUser();
        dRef = FirebaseDatabase.getInstance().getReference().child("DoctorTiming");
        Intent data = getIntent();
        key = data.getStringExtra("key");
        back = findViewById(R.id.backTime);
        ...
        save = findViewById(R.id.doc_save);
        ...
        dRef.child(mUser.getUid()).child(key).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isData) {
                    ...
                    dRef.child(mUser.getUid()).child(key).updateChildren(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(HosDocTimeActivity.this, "Updated", Toast.LENGTH_SHORT).show();
                                //   startActivity(new Intent(DoctorTimingActivity.this, DoctorActivity.class));
                                finish();
                            }
                        }
                    });
    ...
    private void validData(String verify) {
        if (verify.isEmpty()) {
            isData = false;
